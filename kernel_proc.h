...
typedef struct process_thread_control_block{
  ...
  TCB* ptcb_thread;       /**< The main thread */
  
  Task ptcb_thread_task;  /**< The main thread's function */
  int argl;               /**< The main thread's argument length */
  void* args;             /**< The main thread's argument string */
  ...
  CondVar cond_var_joiners;     /**< Condition variable for joining threads */
  
  int ref_count;      /**< It is being increased when thread_join terminates successfully */
  int exitval;        /**< The exit value */
  
  rlnode ptcb_rlnode;
  PTCB* prev;  /**< previous context */
  PTCB* next;  /**< next context */
} PTCB;
