...
#endif
  int priority; /**< This variable declares the priority of the thread in MFQ architecture of the shceduler*/
  Thread_type type;       /**< The type of thread */
  Thread_state state;    /**< The state of the thread */
  Thread_phase phase;    /**< The phase of the thread */
  enum SCHED_CAUSE cause_of_yield; /**< The cause that the thread called yield */
